...
public class TowerManager : MonoBehaviour
{
    ...
    private bool CalculateAngle(Transform objectToRotate, Vector3 targetToRotateTo, int rotationAxis = 0)
    {
        ...
        {
            case 1:
                objectToRotate.Rotate((100 * clockwise * Time.fixedDeltaTime), 0.0f, .0f);
                break;
            case 2:
                objectToRotate.Rotate(0.0f, (100 * clockwise * Time.fixedDeltaTime), .0f);
                break;
            case 3:
                objectToRotate.Rotate(0.0f, 0.0f, (100 * clockwise * Time.fixedDeltaTime));
                break;
        }
        return true;
    }
